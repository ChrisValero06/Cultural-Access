...
export const CarruselProvider = ({ children }) => {
  ...
  /** Envía los textos actuales al backend (solo al hacer clic en "Publicar"). */
  const publicarTextosPromociones = () => {
    const current = textosPromociones || { titulo: 'PROMOCIONES VIGENTES - FEBRERO', subtitulo: 'Presentando tarjeta y sujetas a disponibilidad' };
    return configService.updateTextosPromociones(current);
  };
