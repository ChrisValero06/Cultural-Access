  ...
  const cargarEstadisticas = async () => {
    try {
      ...
      const stats = {
        ...
        francisco: usuarios.filter(u => u.registrado_por === 'francisco').length,
        planeacion: usuarios.filter(u => u.registrado_por === 'planeacion').length,
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold">Francisco</h3>
            <div className="bg-white/20 rounded-full p-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
          ...
          <div className="text-4xl font-bold mb-2">{estadisticas.francisco}</div>
        ...
        <div className="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg p-6 text-white shadow-lg">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-bold">Planeación</h3>
            <div className="bg-white/20 rounded-full p-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
              </svg>
          ...
          <div className="text-4xl font-bold mb-2">{estadisticas.planeacion}</div>
          <p className="text-cyan-100 text-sm">usuarios registrados</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between items-center py-2 border-b">
            <span className="text-gray-700">Francisco</span>
            <span className="font-bold text-indigo-600">{estadisticas.francisco} usuarios</span>
          </div>
          <div className="flex justify-between items-center py-2 border-b">
            <span className="text-gray-700">Planeación</span>
            <span className="font-bold text-cyan-600">{estadisticas.planeacion} usuarios</span>
          </div>
          <div className="flex justify-between items-center py-2 border-b">
