...
const Footer = () => {
  return (
    <footer className="bg-orange-500 text-white">
      <div className="max-w-[1080px] mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-8">
                ...
                <li>
                  <a href="/privacidad" className="!text-white hover:!text-white transition-colors duration-200" style={{color: 'white !important'}}>
                    Aviso de privacidad
                       ...
                       {/* Soporte */}
            <div>
              <h3 className="text-sm md:text-lg font-semibold mb-1 md:mb-4 text-white">Soporte</h3>
              <ul className="space-y-1 md:space-y-2">
                <li>
          ...
          {/* Redes Sociales */}
          <div>
            <h3 className="text-sm md:text-lg font-semibold mb-1 md:mb-4 text-white">Redes Sociales</h3>
            <div className="flex space-x-3 md:space-x-4">
              ...
              >
                <svg className="w-5 h-5 md:w-8 md:h-8" fill="white" viewBox="0 0 24 24">
